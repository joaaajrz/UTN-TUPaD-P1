...
# numsMultiplos4 = list(range(0,100,4))
...
# lista = ["Hola", 20, False, "Gaston", 40 ]
# elementoCinco = lista[3]
# print(elementoCinco)
...
# Respuesta: En la primer linea se crea una lista con numeros enteros. En la segunda linea se elimina el numero de mayor valor. Por ultimo se imprime la lista sin el numero(22)
